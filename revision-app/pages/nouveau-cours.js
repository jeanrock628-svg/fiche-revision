...
export default function NouveauCours() {
  ...
  async function creerCours(e) {
    ...
    try {
      ...
      console.error(err);
      // Message détaillé temporaire, le temps de diagnostiquer un souci de configuration.
      // Une fois que tout fonctionne, on pourra remettre un message plus simple pour l'utilisateur final.
