...
export default function Accueil() {
  ...
  async function valider(e) {
    ...
    if (mode === 'signup' && !data.session) {
      setErreur('');
      setMessageConfirmation("Compte créé ! Vérifie ta boîte mail pour confirmer ton adresse avant de te connecter.");
      return;
    }
  ...
  return (
    <div className="page">
      ...
      <form onSubmit={valider}>
        ...
        {messageConfirmation && <p style={{ color: '#3C7A5C', fontSize: 14 }}>{messageConfirmation}</p>}
